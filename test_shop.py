...
class TestCart:
    ...
    def test_add_some_products(self, cart_with_product):
        cart, product = cart_with_product
        cart.add_product(product, 5)
        assert cart.products[product] == 10

    def test_remove_1_product(self, cart_with_product):
        cart, product = cart_with_product
    ...
    def test_buy_more_than_available(self, cart_with_product):
        cart, product = cart_with_product
